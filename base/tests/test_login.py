...
from djangopp.django_assertions import assert_contains, assert_not_contains
...
def test_botao_entrar_disp(resp_home):
    assert_contains(resp_home, 'Entrar')


def test_link_de_login_disp(resp_home):
...
def test_botao_entrar_indisp(resp_home_com_usuario_logado):
    assert_not_contains(resp_home_com_usuario_logado, 'Entrar')


def test_link_de_login_inddisp(resp_home_com_usuario_logado):
    assert_not_contains(resp_home_com_usuario_logado, reverse('login'))


def test_botao_sair_disp(resp_home_com_usuario_logado):
...
def test_link_de_logout_disp(resp_home_com_usuario_logado):
